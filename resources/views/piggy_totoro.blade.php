...
@section('title')
  กระปุกออมสิน Totoro, โทโทโร่ | Little Reveurs
@stop

@section('description')
 ขายกระปุกออมสิน Totoro, โทโทโร่ ราคาถูก, ขายกระปุกออมสินโทโทโร่ราคาส่ง, กระปุกออมสินโทโทโร่ พร้อมส่ง มีให้เลือกหลายแบบไปสะสม ลิขสิทธิ์แท้ นำเข้าจากญี่ปุ่น
@stop

@section('ogtags')
    @include('layouts-front.og_tags', ['title' => 'กระปุกออมสิน Totoro, โทโทโร่ | Little Reveurs', 'description' => ' ขายกระปุกออมสิน Totoro, โทโทโร่ ราคาถูก, ขายกระปุกออมสินโทโทโร่ราคาส่ง, กระปุกออมสินโทโทโร่ พร้อมส่ง มีให้เลือกหลายแบบไปสะสม ลิขสิทธิ์แท้ นำเข้าจากญี่ปุ่น',
...
<br><br>
        ...
        <div class="col-md-12 " >
          <a href="#" style="width:100%;display:block;">
            <img src="{{url('assets/img/my-neighbour-totoro-banner.jpg')}}" class="img-responsive" style="border: 1px solid #e0e0e0; margin: 0 auto; height:180px;">
          </a>
        </div>
        </div>
